    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
              {{--************************************alix start**************************************************--}}
                  <div class="row">
                      <div class="col-md-3">Goods</div>
                      <div class="col-md-1">Unit Price</div>
                      <div class="col-md-1">Price</div>
                      <div class="col-md-1">Quantity</div>
                      <div class="col-md-1">Goods Action</div>
                      <div class="col-md-1">Amount</div>
                      <div class="col-md-1">Status</div>
                      <div class="col-md-1">Order Action</div>
                  </div>
              {{--************************************alix end****************************************************--}}
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <div class="data-table table table-bordered table-hover">
                            <div>
                                <ul>
                                    <li>ID</li>
                                    <li>订单号</li>
                                    ...
                                    <li>支付金额</li>
                                    <li>订单状态</li>
                                    <li>{{ trans('core::core.table.created at') }}</li>
                                    <li data-sortable="false">{{ trans('core::core.table.actions') }}</li>
                                </ul>
                            </div>
                            <tbody>
                            <?php if (isset($orders)): ?>
